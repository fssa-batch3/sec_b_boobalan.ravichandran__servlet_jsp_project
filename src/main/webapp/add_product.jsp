...
<body>
	...
	<form action="create" method="post">
		<label>Product Name:</label> <input type="text" name="name"
			required="true" autofocus> <label>Product Weight:</label> <input
			type="text" name="product_weight" required="true"> <label
		...
		<label>Manufacture:</label> <input type="text" name="manufacture"
			required> <label>Price:</label> <input type="text"
			name="price" id="custom-number-input" required pattern="[0-9]+"
			min="1"> <label>Discount:</label> <input type="text"
			name="discount" id="custom-discount-input" required pattern="[0-9]+"
			min="1"> <label>Image URL:</label> <input type="file"
			name="image_url" id="custom-valid-input" required> <input
			type="hidden" id="custom-image-input">
